...
<div class="d-flex justify-content-lg-between mt-5">
    <div class="d-flex align-items-center gap-4">
        ...
        <p class="m-0 fs-5">+ 300 Customer</p>
    </div>
    <div class="d-flex align-items-center gap-4">
...
<div class="row  mb-md-5">
    ...
    <div class="col-md-7">
        <div class="card">
            ...
            <div class="card-body">
                <p class="p-0 mb-5 text-lg-center">Please provide your criticism and suggestions for our application so
                    that we can meet your needs and improve further.</p>
                <div class="mb-3 row">
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="pesan" placeholder="Enter Your Message">
                    </div>
                </div>
                <button class="btn btn-primary mt-4 w-100"> Send your message</button>
            </div>
        </div>
    </div>
</div>
