        ...
        <div class='dashboard-app'>
            ...
            <div class='dashboard-content'>
                <div class='container'>
                    ...
                    <div class="item">
                        <a href="{{ route('product.index') }}"><h4 class="text-danger">Edite Products</h4></a>
                    ...
                    <div class="container">
                        <div class="row">
                            <form action="{{ route('product.update', $product->id) }}" method="POST">
                                ...
                                <input type="submit" class="btn btn-primary btn-sm" onclick="return alert('Update Successfully')"
                                    value="update">
                            </form>
                            </table>
                        </div>
