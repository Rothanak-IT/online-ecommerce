...
class Controller extends BaseController
{
    ...
    public function prosesCheckout(Request $request, $id)
    {
        ...
        Alert::toast('Checkout Successful', 'success');
    ...
    public function prosesPembayaran(Request $request)
    {
        ...
        Alert::alert()->success('Transaction Successful', 'Waiting for the item');
    ...
    public function loginProses(Request $request)
    {
        ...
        if ($proses->is_admin === 0) {
            ...
            if (Auth::attempt($dataLogin)) {
                Alert::toast('You are login successfully.', 'successful');
                $request->session()->regenerate();
                return redirect()->intended('/admin/dashboard');
            } else {
                Alert::toast('Email and Password are incorrect.', 'error');
                return back();
            }
        }
    }
    ...
    public function logout()
    {
        ...
        Alert::toast('You have logout.', 'successfully');
