        ...
        <div class="modal-content modal-md">
            ...
            <form action="{{ route('addDataUser') }}" enctype="multipart/form-data" method="POST">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3 row">
                        <label for="tlp" class="col-sm-5 col-form-label">Tel phone</label>
                        <div class="col-sm-7">
                            <input type="text" class="form-control" id="tlp" name="tlp">
                        </div>
                    </div>
                    <div class="mb-3 row">
                        <label for="tglLahir" class="col-sm-5 col-form-label">Date</label>
                        <div class="col-sm-7">
                            <input type="date" class="form-control" id="tglLahir" name="tglLahir">
                        </div>
                    </div>
                    <div class="mb-3 row">
                        <label for="role" class="col-sm-5 col-form-label">Status</label>
                        <div class="col-sm-7">
