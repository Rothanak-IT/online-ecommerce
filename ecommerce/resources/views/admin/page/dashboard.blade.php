...
@section('content')
        ...
        <div class="card" style="width: 250px;">
            <div class="card-body">
                <div class="d-flex gap-2 align-items-center justify-start">
                    ...
                    <h5 class="p-0 m-0" style="color:green">Total Payment</h5>
                </div>
        ...
        <div class="card" style="width: 250px;">
            <div class="card-body">
                <div class="d-flex gap-2 align-items-center justify-start">
                    ...
                    <h5 class="p-0 m-0" style="color:green">Earnings</h5>
                </div>
                <span class="fs-2 p-0 m-0">{{ number_format($dataPenghasilan / 1000000, 2) . ' $' }}</span>
            </div>
        </div>
    </div>
    ...
    <div class="row gap-2">
        ...
        <div class="card rounded-full mt-2" style="width: 100%;">
