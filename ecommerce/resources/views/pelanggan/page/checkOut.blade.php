        ...
        <div class="col-sm-8">
            <div class="card">
                <div class="card-body ekspedisi">
                    ...
                    <div class="row mb-3">
                        <label for="nama_penerima" class="col-form-label col-sm-3">Name Recipient</label>
                        <div class="col-sm-9">
                    ...
                    <div class="row mb-3">
                        <label for="alamat_penerima" class="col-form-label col-sm-3">Recipient Address</label>
                        <div class="col-sm-9">
                    ...
                    <div class="row mb-3">
                        <label for="tlp" class="col-form-label col-sm-3">Phone Number Recipient</label>
                        <div class="col-sm-9">
                    ...
                    <div class="row mb-3">
                        <label for="ekspedisi" class="col-form-label col-sm-3">Courier</label>
                        <div class="col-sm-9">
                            <select name="ekspedisi" class="form-control eksp" id="ekspedisi">
                                ...
                                <option value="ninja">NiKi Express</option>
                            </select>
                        </div>
                    </div>
                </div>
        ...
        <div class="col-sm-4">
            <div class="card">
                ...
                <div class="card-body pembayaran">
                    ...
                    <div class="row mb-3">
                        <label for="totalBelanja" class="col-form-label col-sm-6">Total Shopping</label>
                        <div class="col-sm-6">
                    ...
                    <div class="row mb-3">
                        <label for="ongkir" class="col-form-label col-sm-6">Delivery fee</label>
                        <div class="col-sm-6">
                    ...
                    <div class="row mb-3">
                        <label for="dibayarkan" class="col-form-label col-sm-6">Quantity of goods</label>
                        <div class="col-sm-6">
